...
- Peta: `lib/map/map_screen.dart`
  ...
  - Tombol kanan bawah meminta izin lokasi lewat `geolocator`, lalu memusatkan peta ke lokasi pengguna dengan animasi scroll.
  - Tombol flag di atas tombol lokasi membuka tray aksi `Check-in` dan `Check-out` dengan animasi slide.
